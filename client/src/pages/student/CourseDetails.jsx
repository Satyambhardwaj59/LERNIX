    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
            ...
            <div className='flex'>
              {[...Array(5)].map((_, i) => (
                <img
                  ...
                  src={i < calculateRating(courseData) ? assets.star : assets.star_blank}
                  alt="star"
                />
              ))}
            </div>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Sonu Kumar</span></p>
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={() => toggleSection(index)}>
                    ...
                    <p className='text-sm md:text-[15px] md:leading-[21px]'>{chapter.chapterContent.length} lecture - {calculateChapterTime(chapter)}</p>
                  </div>
        ...
        <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <button className='bg-blue-600 text-white font-medium md:mt-6 mt-4 w-full py-3 rounded'>{isAlreadyEnrolled ? "Already Enrolled" : "Enroll Now"}</button>

            <div className='pt-6'>
              <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course</p>
              <ul className='ml-4 pt-2 text-sm md:text-defalult list-disc text-gray-500'>
