  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0 '>
      ...
      <div className='flex items-center gap-6 font-medium mt-4'>
        <button className='px-10 py-3 cursor-pointer bg-blue-600 text-white rounded-md'>Get Started</button>
        <button className='flex cursor-pointer items-center gap-2'>Learn More <img src={assets.arrow_icon} alt="arrow-icon" /></button>
      </div>
    </div>
  )
}
