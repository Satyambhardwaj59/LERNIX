    ...
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-8 mt-14' >
        {dummyTestimonial.map((testimonial, index)=> (
          <div className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px]' key={index}>
            <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10 overflow-hidden shadow-black/5'>
