    ...
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        ...
        <div className='hidden md:flex flex-col items-start w-full '>
          ...
          <p className='text-white mb-3'> The latest news, articles, and resources, sent to your inbox weekly.</p>
          <div className='mt-5 flex w-full gap-2'>
            <input type="email" placeholder='enter your email'  className='border border-gray-500/30 bg-gray-800 text-gray-500 placeholder-gray-500/30 outline-none w-64 h-9 rounded px-2 text-sm'/>
            <button className='bg-blue-600 text-white rounded w-24 h-9 '>Subscribe</button>
          </div>
        </div>
      </div>

      <p className='py-6 text-center text-xs md:text-sm text-white/60'>Copyright © 2025 Lernix. All rights reserved.</p>
    </footer>
  )
}
